...
class MultiFactorBacktest:
    ...
    def load_data(self):
        ...
        # 加载ZL模型数据
        print("  加载 ZL模型数据...")
        bs_file = self.data_dir / "ZL_Model_Summary.xlsx"
        ...
        self.factors["zl_deviation"] = bs_dev
    ...
    def check_factor_correlation(self):
        ...
        save_path = self.data_dir / "ZL_factor_correlation.png"
    ...
    def print_performance_summary(self):
        ...
        # 保存到CSV
        save_path = self.data_dir / "Z-L_alpha_strategy_metrics.csv"
...
def main():
    ...
    # 绘图
    backtest.plot_results(save_path=Path(data_dir) / "Z-L_alpha_strategy_chart.png")

    # 保存结果
    backtest.save_results(Path(data_dir) / "Z-L_alpha_strategy_results.csv")
