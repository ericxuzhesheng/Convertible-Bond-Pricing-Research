...
\begin{table}[h]
  ...
  \begin{tabular}{lrrrrr}
    ...
    \midrule
    BS & 19.33\% & 0.91 & -28.96\% & 19.09\% & 54.33\% \\
    ZL & 20.48\% & 0.94 & -29.75\% & 19.78\% & 57.34\% \\
    \bottomrule
  \end{tabular}
\end{table}

同期中证转债基准年化收益为 \textbf{7.08\%}。BS 与 ZL 六因子组合的
年化超额收益分别为 12.25\% 和 13.40\%。最新样本中 ZL 的收益和夏普略高，
但两类组合均经历接近 30\% 的最大回撤，因此模型定价信号不应被视为独立的
低风险套利。

\sectionbar{二、定价结果与最新截面}

截至 2026-08-28，BS 模型有 313 只有效定价，ZL 模型有 301 只有效定价。
在各自有效样本上，理论价格相对市场价格偏离度的截面中位数分别为
\textbf{-6.14\%} 与 \textbf{-17.83\%}。该结果说明当前绝对定价模型普遍给出
...
\begin{table}[h]
  ...
  \begin{tabular}{llrrrr}
    ...
    \midrule
    BS & 定价偏差单因子 & 20.34\% & 1.20 & -21.76\% & 307.68\% \\
    BS & 六因子等权 & 19.33\% & 0.91 & -28.96\% & 282.41\% \\
    ZL & 定价偏差单因子 & 22.31\% & 1.37 & -14.99\% & 360.95\% \\
    ZL & 六因子等权 & 20.48\% & 0.94 & -29.75\% & 311.30\% \\
    \bottomrule
  \end{tabular}
\end{table}
